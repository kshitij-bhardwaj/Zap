...
module.exports = {
    ...
    run : async(client, message, args) => {
        const member = message.mentions.members.first() 
            ...
            message.channel.send(`${member}`,{embed:{color:`${resources['embed-fun']}`, description:`Confirmation to play TicTacToe with ${message.author.tag}`}}).then(async msg => {
              ...
              // delete the confirmation message
                msg.delete()
                message.channel.send({embed:{color:`${resources['embed-fun']}`, description:`${message.author.tag}! Your invitation has been rejected`}})
              }
